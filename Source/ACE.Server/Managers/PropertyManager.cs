    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("enforce_player_movement", new Property<bool>(true, "if enabled, server is authoritative on player movement, otherwise client is authoritative")),
                ("enforce_player_movement_kick", new Property<bool>(true, "if enabled, server will kick clients that go above enforce_player_movement_kick_threshold")),
                ("enforce_player_movement_speed", new Property<bool>(true, "if enabled, server is authoritative on player movement speed, otherwise client is authoritative")),
        ...
        public static readonly ReadOnlyDictionary<string, Property<long>> DefaultLongProperties =
            DictOf(
                ...
                ("enforce_player_movement_kick_threshold", new Property<long>(10, "the amount of allowed movement enforcements per minute by the server before client is booted")),
