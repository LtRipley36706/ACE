...
namespace ACE.Server.GLS
{
    partial class Program
    {
        ...
        {
            var consoleTitle = $"ACEmulator GLS - v{ServerBuildInfo.FullVersion}";
            ...
            {
                consoleTitle = $"{ConfigManager.Config.Server.WorldName} | GLS: 0x{NetworkManager.ServerId:X} | {consoleTitle}";
                Console.Title = consoleTitle;
            }
